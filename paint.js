// This helper function creates an element with the given name and attributes
...
// Because we want to build our program piece by piece, we define an object called
// controls, which will hold functions to initialize the various controls below the image.
...
// This object associates the names of the tools with the function that should be called
...
// The clientX and clientY properties on mouse events are also relative to this corner, so we can
// subtract the top-left corner of the canvas from them to get a position relative to that corner.
...
// This implement the erase tool on top of the line tool.
...
// this implement the color picker
...
// The field for configuring the brush size.
...
// We’ll need the following helper function, which tries to load an 
...
// We load the file that the user chose as a data URL and pass 
